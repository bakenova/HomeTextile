	...
	<main class="about-main">
		<section class="page-container">
			<section class="about-section">
				...
				<img src="<?= SITE_DIR ?>/local/assets/images/store.png" alt="Store Image" class="store-image" />
			</section>

			<section class="team-section">
				<img src="<?= SITE_DIR ?>/local/assets/images/team.png" alt="Team Image" class="team-image" />
				...
				<div class="location-content">
					<div class="location-info">
						<p>Conveniently located in the heart of
							...
							it's an experience. Our welcoming atmosphere invites you to explore a curated selection of quality home textiles, from cozy bedding to elegant decor pieces, creating a haven that reflects your unique style. Immerse yourself in the latest trends and discover the transformative power of our carefully chosen collection. Whether you're furnishing a new home or looking to refresh your living space, our store is your trusted partner in creating a home that feels uniquely yours.
						</p>
					</div>

					<div class="location-image">
						<img src="<?= SITE_DIR ?>/local/assets/images/location.png" alt="Location Image" class="location-imagee" />
					</div>
