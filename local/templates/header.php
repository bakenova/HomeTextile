<header id="defaultHeader" style="display:block;">
	<nav>
		<ul>
			<li>
			...
			<li>
				<a href="<?= SITE_DIR ?>/products.html">Products</a>
			</li>
			<li class="logo">
...
<!-- Profile header -->
<header id="profileHeader" style="display:none;">
	<nav>
		<ul>
			<li class="logo">
				<a href="<?= SITE_DIR ?>/index.php">
